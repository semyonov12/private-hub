(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".learn__slider")) new Swiper(".learn__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
        ...
        class app_Parallax {
            constructor(elements) {
                if (elements.length) this.elements = Array.from(elements).map(el => new app_Parallax.Each(el, this.options));
            }
            destroyEvents() {
        ...
        if (document.querySelectorAll("[data-prlx-parent]")) {
            new app_Parallax(document.querySelectorAll("[data-prlx-parent]"));
        }
        ...
        if (typedElements.length) {
            const checkTyped = setInterval(() => {
                typedElements.forEach(el => {
                    if (!el.dataset.typedInit && el.classList.contains("aos-animate")) {
                        el.dataset.typedInit = true;
                ...
                if ([ ...typedElements ].every(el => el.dataset.typedInit)) clearInterval(checkTyped);
            }, 100);
        }
    })();
})();